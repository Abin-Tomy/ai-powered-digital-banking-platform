            ...
            <>
              ...
              {!tokenValid ? (
                <div className="text-center py-4">
                  ...
                  <p className="text-purple-300 text-sm mb-6">This reset link has expired or is invalid. Please request a new one.</p>
                  <button
                  ...
                  <a href="/login" className="block mt-4 text-purple-400 hover:text-purple-300 text-sm transition-colors">
                    ← Back to Login
                  </a>
                </div>
              ) : (
