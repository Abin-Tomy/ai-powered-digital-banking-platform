...
export default function SupportDashboardLayout({ children }: SupportDashboardLayoutProps) {
  ...
  const navItems = [
    ...
    { path: "/chat", label: "Live Chat", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
    { path: "/customer360", label: "Customer 360", icon: "M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
    { path: "/support/users", label: "User Lookup", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" },
    { path: "/support/fraud", label: "Fraud Review", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
  ];
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="hidden md:block">
                  <div className="text-white text-sm font-medium">{agentName}</div>
                  <div className="text-xs">
                    <span className="bg-purple-500/30 text-purple-300 px-1.5 py-0.5 rounded text-xs">SUPPORT</span>
                  </div>
                </div>
              </div>
              <button
