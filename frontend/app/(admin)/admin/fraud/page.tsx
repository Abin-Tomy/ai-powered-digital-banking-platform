        ...
        <div className="space-y-4">
          {filteredFlags.length === 0 ? (
            ...
            filteredFlags.map((flag) => (
              <div
                key={flag.id}
                className="bg-slate-900/70 backdrop-blur-xl rounded-2xl p-6 border border-red-500/20"
              >
                  ...
                  {flag.status === "PENDING" && (
                    <div className="flex gap-3">
                      <button
                        ...
                        className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg border border-red-500/30 font-medium transition-all"
                      >
                        Review
                      </button>
                    </div>
